...
tk.Label(login_frame, text="Choose Username").grid(row=1, column=0, padx=10, pady=10)
tk.Entry(login_frame).grid(row=1, column=1, padx=10, pady=10)

#password and textbox
tk.Label(login_frame, text="Choose Password").grid(row=2, column=0, padx=10, pady=10)
tk.Entry(login_frame, show="*").grid(row=2, column=1, padx=10, pady=10)

#sign up button
tk.Button(login_frame, text="Sign up").grid(row=3, column=0, columnspan=2, pady=10)
